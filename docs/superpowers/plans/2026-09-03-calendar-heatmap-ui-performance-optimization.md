...
- [ ] **Step 1: Add deterministic summary and visual-count tests**
...
- [ ] **Step 3: Implement repeated measurement without changing the template**
...
- [ ] **Step 4: Print and preserve the baseline**
...
- [ ] **Step 5: Run full regression and commit the harness**
...
- [ ] **Step 1: Add rendering and accessibility contract tests**
...
- [ ] **Step 3: Implement the self-rendering Button**
...
- [ ] **Step 4: Replace the inline ControlTemplate**
...
- [ ] **Step 5: Run five-sample gate and take the branch decision**
...
- [ ] **Step 1: Add week-grouping and atomic-publication tests**
...
- [ ] **Step 3: Build week groups from existing cells**
...
- [ ] **Step 4: Run projection, atomic-publication and full tests**
...
- [ ] **Step 1: Add virtualization, endpoint and scroll-sync tests**
...
- [ ] **Step 3: Recompose the calendar body into synchronized regions**
...
- [ ] **Step 4: Synchronize the month axis**
...
- [ ] **Step 5: Replace the old full-realization assertion**
...
- [ ] **Step 6: Run five-sample gate, interaction tests and commit**
...
- [ ] **Step 1: Run complete automated gates five times**
...
- [ ] **Step 3: Review scope and conditional path**
...
- [ ] **Step 4: Update evidence without deleting historical values**
...
- [ ] **Step 5: Commit final UI performance evidence**
