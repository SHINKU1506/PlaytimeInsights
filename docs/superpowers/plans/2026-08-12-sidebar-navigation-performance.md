...
- [x] **Step 1: Add the failing navigation lifecycle regression**
...
- [x] **Step 3: Implement the minimal navigation fix**
...
- [x] **Step 1: Add the failing session count boundary regression**
...
- [x] **Step 3: Implement the minimal count fix**
...
- [x] **Step 1: Run a clean Release build and complete regression suite**
...
- [x] **Step 2: Review scope and production diff**
...
- [x] **Step 4: Deploy with data protection checks**
...
- [x] **Step 6: Hand off client verification**
